...
#function_apt_wait_for_unlock sudo apt-get install -y --allow-downgrades libc6=2.35-0ubuntu3
...
function_apt_wait_for_unlock sudo apt-get install -y g++-16 gcc-16
...
# Python 3.10.12 is part of ubuntu 22.04 now
function_apt_wait_for_unlock sudo apt-get install -y python3.14-dev rofi python3-pip pipx python3.14-venv
...
cd $homedir/.local/lib/python3.14/site-packages/
...
function_apt_wait_for_unlock ./setup_nodejs_24p11p1.sh
...
function_apt_wait_for_unlock sudo apt-get install -y python3.14-venv
